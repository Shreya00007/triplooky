...
<div class="wrapper">
  ...
  <div class="container">
    ...
    <img src="{{url('')}}/front-assets/assets/img/newtriplogo.svg" > 

   

    <h6 class="name" style="font-size:22px;">Admin Login</h6>

    



    <form class="admin-form text-left" >
    ...
    <div class="d-flex" style="align-items:center;justify-content:space-between;">
      ...
      <button type="submit" id="login-button" style="font-family: 'Poppins', sans-serif!important;">Login</button>
       ...
       $.ajax({
          ...
          type:"POST",
           ...
           beforeSend:function(){
            ...
            $(".admin-form").find("button").html("Processing...");

            $(".admin-form").find("button").attr("disabled",true);
           ...
           success:function(response){
            ...
            $(".admin-form").find("button").attr("disabled",false);

              $(".admin-form").find("button").html("Login");
