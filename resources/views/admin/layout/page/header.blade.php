                ...
                <div class="col-lg-12">
                    ...
                    <div class="menu-wrapper">
                        ...
                        <div class="logo mr-5">
                            ...
                            <a href="/admin/index"><img src="{{url('')}}/admin-asstes/images/logo.png" alt="logo"></a>
                                                ...
                                                <a href="#" class="list-group-item list-group-item-action">
                                                    ...
                                                    <div class="msg-body d-flex align-items-center">
                                                        ...
                                                        <div class="avatar flex-shrink-0 mr-3">
                                                            ...
                                                            <img src="{{url('')}}/admin-asstes/images/team9.jpg" alt="">
                                                ...
                                                <a href="#" class="list-group-item list-group-item-action">
                                                    ...
                                                    <div class="msg-body d-flex align-items-center">
                                                        ...
                                                        <div class="avatar flex-shrink-0 mr-3">
                                                            ...
                                                            <img src="{{url('')}}/admin-asstes/images/team10.jpg" alt="">
                                                ...
                                                <a href="#" class="list-group-item list-group-item-action">
                                                    ...
                                                    <div class="msg-body d-flex align-items-center">
                                                        ...
                                                        <div class="avatar flex-shrink-0 mr-3">
                                                            ...
                                                            <img src="{{url('')}}/admin-asstes/images/team11.jpg" alt="">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <a href="#" class="dropdown-toggle" id="userDropdownMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="avatar avatar-sm flex-shrink-0 mr-2"><img src="{{url('')}}/admin-assets/images/admin_image/{{$data->admin_image}}" alt="team-img"></div>

                                                <span class="font-size-14 font-weight-bold">{{$data->admin_name}}</span>
                                        ...
                                        <div class="dropdown-menu dropdown-reveal dropdown-menu-md dropdown-menu-right">
                                            ...
                                            <div class="list-group drop-reveal-list user-drop-reveal-list">
                                                ...
                                                <a href="/admin/logout" class="list-group-item list-group-item-action">
