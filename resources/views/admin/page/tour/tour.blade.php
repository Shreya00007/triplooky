                    ...
                    <div class="col-lg-6">
                        <div class="breadcrumb-content">
                            <div class="section-heading">
                                <h2 class="sec__title font-size-30 text-white p-font">Tour Setting</h2>
                            </div>
                        ...
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                <div class="card-header d-flex justify-content-between align-items-center py-3" style="background: #28e5f3;border-radius: 2px;">
                                    <div> <h4 class="text-white p-font"><b>Add New Tour</b></h4></div>
                                    <div><span></span></div>
                                </div>
                                <div class="card-body">
                                     <form class="tour-form">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tour_name" class="form-control shadow-none rounded-0 require" placeholder="Tour Name">
                                        </div>
                                        <div class="row">
                                              <div class="col col-sm-12"><div class="form-group">
                                            <label class="p-font">Tour Photo</label>
                                            <input type="file" name="tour_image" class="form-control shadow-none rounded-0 require" placeholder="Tour Photo">
                                        </div></div>
                                        </div>
                                        <div class="row">
                                            <div class="col ">
                                    ...
                                    <div class="col ">
                                        <div class="form-group">
                                              <label class="p-font">Select Sub Category</label>
                                      ...
                                      <div class="col">
                                          <div class="form-group">
                                              ...
                                              <input type="text" name="duration" placeholder="Duration" class="form-control shadow-none require">
                                          </div>
                                      </div>
                                      <div class="col">
                                          <div class="form-group">
                                              <label class="p-font">Departure Time</label>
                                              <input type="text" name="departure_time"  class="form-control shadow-none require" placeholder="Departure Time">
                                          </div>
                                      </div>
                                  </div>
                                  <div  class="row">
                                ...
                                <div class="form-group">
                                  ...
                                  <div id="editor6" class="add-info editor" data="Additional Inclusions"></div>
                                        ...
                                        <div class="form-group mb-0 d-flex justify-content-between align-items-center">
                                            <button class="btn-custom p-font">Create New Tour</button>
