                                    ...
                                    <table class="table text-center">
                                        ...
                                        <tr style="font-size:20px !important" class="p-font">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button class="btn btn-danger shadow-none edit-activity-status-btn" data="{{$list->id}}" status="0">inactive</button>

                                                @else

                                              <button class="btn btn-success shadow-none edit-activity-status-btn" data="{{$list->id}}" status="1">Active</button>
