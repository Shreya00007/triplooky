...
@section("title","Activity Gallery List")
@section("content")
                        ...
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                <div class="card-header d-flex justify-content-between align-items-center py-3" style="background: #28e5f3;border-radius: 2px;">
                                    <div> <h4 class="text-white p-font"><b>Activity Gallery List</b></h4></div>
                                    <div><span></span></div>
                                </div>
                                <div class="card-body">
                                    <div class="form-group">
                                        <select class="form-control shadow-none activity-name-gallery">
                                            <option>
