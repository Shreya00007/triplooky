                    ...
                    <div class="col-lg-6">
                        <div class="breadcrumb-list text-right">
                            <ul class="list-items">
                                ...
                                <li class="p-font"> Appartment List</li>
                        ...
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                <div class="card-header d-flex justify-content-between align-items-center py-3" style="background: deeppink;border-radius: 2px;">
                                    <div> <h5 class="p-font text-white"><b> Appartment List</b></h5></div>
                                ...
                                <div class="card-body">
                                     ...
                                     <table class="table table-custom">
                                         ...
                                         <tbody>
                                            ...
                                            <tr>
                                                <td>{{$key+1}}</td>
                                                <td>{{$list->appartment_name}}</td>
                                                 <td><img src="{{url('')}}/Appartment/images/thumb_image/{{$list->thumb_image}}" width="100"></td>
                                                <td>
                                                    @if($list->status==1)
                                                    <a href="/admin/appartment/status-change/{{base64_encode($list->id)}}"><button class="btn btn-success shadow-none sub-category-status-btn" data="{{$list->id}}" status="1">Active</button></a>
                                                    @else
                                                    <a href="/admin/appartment/status-change/{{base64_encode($list->id)}}"> <button class="btn btn-danger shadow-none " data="{{$list->id}}" status="0">inactive</button></a>
                                                    @endif
                                                </td>
                                                <td>
                                                    <div class="d-flex justify-content-center align-items-center">
                                                        <a href="/admin/appartment/edit/{{base64_encode($list->id)}}"><button class="edit-city-btn icon-btn bg-success text-white mr-2" data=""><i class="la la-edit"></i>
                                                        </button></a>
                                                        ...
                                                        <a href="/admin/appartment/image/{{base64_encode($list->id)}}"><button class="icon-btn  btn-info text-white shadow-none" data="{{$list->id}}"><i class="la la-picture-o"></i></button></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            @endforeach
