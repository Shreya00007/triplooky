...
@section("title","Update Must Do And See")
@section("content")
<div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="breadcrumb-content">
                            <div class="section-heading">
                                <h4 class="sec__title font-size-30 text-white p-font">Must Do And See Photo Setting</h4>
                            </div>
        ...
        <div class="dashboard-main-content mt-5">
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                ...
                                <div class="card-body">
                                    <form method="post" action="/admin/must-do-and-see/edit-data" enctype="multipart/form-data" class="must-do-and-see-update-form">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control shadow-none" name="type">
                                                ...
                                                <option value="nature_and_discovery" {{$data->type=="nature_and_discovery"?"selected":""}}>Nature & Discovery</option>
                                                <option value="medina_and_culture" {{$data->type=="medina_and_culture"?"selected":""}}>Medina & Culture</option>
                                                <option value="beach_and_sport" {{$data->type=="beach_and_sport"?"selected":""}}>Beach & Sport</option>
                                            </select>
                                             @if($errors->first("type"))
                                          <p class="text-danger p-font">  <i class="la la-warning"></i> <span class="">{{$errors->first('type')}}</span></p>
                                            @endif
                                        </div>
                                         <div class="form-group">
              ...
              <script type="text/javascript">
                  ...
                  $(".must-do-and-see-update-form").submit(function(){
