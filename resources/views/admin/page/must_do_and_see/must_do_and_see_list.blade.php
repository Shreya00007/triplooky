...
@section("title","Must Do & See List")
@section("content")
                                ...
                                <div class="card-body">
                                    <table class="table table-custom">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($list->status==1)
                                                 <a href="/admin/must-do-and-see/status-change/{{base64_encode($list->id)}}"> <button class="btn btn-success">Active</button></a>
                                                @else
                                                  <a href="/admin/must-do-and-see/status-change/{{base64_encode($list->id)}}"> <button class="btn btn-danger">Deactive</button></a>
                                                @endif
                                            </td>
                                            <td>
                                                <div class="btn btn-group">
                                                     <a href="/admin/must-do-and-see/edit/{{base64_encode($list->id)}}">
                                                    <button class="btn rounded-0 btn-success"><i class="la la-edit"></i></button>
                                               </a>

                                                <a href="/admin/must-do-and-see/delete/{{base64_encode($list->id)}}">
                                                    <button class="btn rounded-0 btn-danger"><i class="la la-trash"></i></button>
                                               </a>
                                               <a href="/admin/must-do-and-see/must-do-and-see-multiple-image-list/{{base64_encode($list->id)}}">
