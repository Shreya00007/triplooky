...
@section("title","Add Photo of Must Do And See")
@section("content")
                        ...
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                <div class="card-header d-flex justify-content-between align-items-center py-3" style="background: #28e5f3;border-radius: 2px;">
                                    ...
                                    <div class="">
                                       <a href="/admin/must-do-and-see/must-do-and-see-multiple-image-list/{{base64_encode($data->id)}}">
                                ...
                                <div class="card-body">
                                    <form method="post" action="/admin/must-do-and-see/add-image" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <button class="btn-custom shadow-none">Add Must Do And See Photo</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
