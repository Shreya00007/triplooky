...
@section("title","Add Tour And Activity Photo")
@section("content")
                        ...
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                <div class="card-header d-flex justify-content-between align-items-center py-3" style="background: #28e5f3;border-radius: 2px;">
                                    <div> <h6 class="p-font text-white"><b>Add Tour And Activity Photo</b></h6></div>
                                    <div><a href="/admin/tour-and-activity/tour-and-activity-multiple-image/{{base64_encode($data->id)}}"><button class="btn btn-dark"><i class="la la-arrow-right"></i></button></a></div>
                                   
                                </div>
                                <div class="card-body">
                                    <form method="post" action="/admin/tour-and-activity/add-more-image-tour-and-activity-data" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            <label class="p-font">Tour And Activity Name</label>
