...
<div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="breadcrumb-content">
                            <div class="section-heading">
                                <h2 class="sec__title font-size-30 text-white p-font">Tour & Activity Setting</h2>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="breadcrumb-list text-right">
                            <ul class="list-items">
                                ...
                                <li class="p-font"> Tour & Activity </li>
                        ...
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                <div class="card-header d-flex justify-content-between align-items-center py-3" style="background: #28e5f3;border-radius: 2px;">
                                    <div> <h6 class="p-font text-white"><b>Add Tour & Activity</b></h6></div>
                                   
                                </div>
                                <div class="card-body">
                                     <form action="/admin/tour-and-activity/add-tour-and-activity-data"    enctype="multipart/form-data" method="post" class="tour-and-activity-form">
                                        @csrf
                                         
                                        <div class="form-group">
                                            <label class="p-font">Tour & Activity Name</label>
                                            <input type="text" name="name" class="form-control shadow-none " placeholder="Tour & Activity Name" oninput="removeErrorshow(this)" value="{{old('name')}}">
                                            @if($errors->has('name'))
                                     ...
                                     <input type="text" name="phone" class="form-control shadow-none " placeholder="Phone No" oninput="removeErrorshow(this)" value="{{old('phone')}}"  maxlength="50">
                                         ...
                                         <div class="form-group">
                                          ...
                                          <select class="form-control shadow-none p-font" name="type">
                                             ...
                                             <option value="{{$activity->name}}"  {{old('type')==$activity->name?"selected":""}}>{{$activity->name}}</option>
                                             @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="duration" class="form-control shadow-none" placeholder="Duration" oninput="removeErrorshow(this)" value="{{old('duration')}}">
        ...
        <option value="{{$lang->lang_name}}" @if (old('lang_name')==$lang->lang_name) selected="selccted" @endif>{{$lang->lang_name}}</option>
                                ...
                                <div class="form-group">
                                  <button class="btn-custom p-font">Add Tour & Activity</button>
                                </div>
              ...
              <script type="text/javascript">
                  ...
                  $(".tour-and-activity-form").submit(function(){
