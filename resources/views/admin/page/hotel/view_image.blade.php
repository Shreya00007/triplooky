                    ...
                    <div class="col-lg-6">
                        <div class="breadcrumb-content">
                            <div class="section-heading">
                                <h2 class="sec__title font-size-30 text-white p-font">View Image  Setting</h2>
                            </div>
                        ...
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                <div class="card-header d-flex justify-content-between align-items-center py-2" style="background: deeppink;border-radius: 2px;">
                                    <div> <h5 class="p-font text-white"><b> Photo  List of {{$hotel->hotels_name}}</b></h5></div>
                                    <div>
                                         ...
                                         <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$hotel->hotels_name}}</td>
                                                 <td><img src="{{url('')}}/hotels_image/images/multiple_image/{{$list->image}}" width="100"></td>
                                                
                                                <td>
                                                    <div class="d-flex justify-content-center align-items-center">
                                                       <button class="edit-city-btn icon-btn bg-success text-white mr-2 edit-hotel-image-btn" data="{{$list->id}}" ><i class="la la-edit"></i>
                                                        </button>
                                                       <a href="/admin/hotel/multiple_image/delete/{{$list->id}}" onclick="return confirm('Are Your Sure To Remove Photo')"><button class="icon-btn  btn-danger text-white shadow-none mr-2" data="{{$list->id}}" ><i class="la la-trash"></i></button>
                                                        </button></a>
  ...
  <div class="modal-dialog " role="document">
    <div class="modal-content rounded-0">
      <div class="modal-header rounded-0 bg-light">
        <h5 class="modal-title p-font" id="exampleModalCenterTitle"><b>Add Photo of {{$hotel->hotels_name}}</b></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form class="hotel-multiple-image-form">
...
<div class="modal fade" id="update-image-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog " role="document">
    <div class="modal-content rounded-0">
      <div class="modal-header rounded-0 bg-light">
        <h5 class="modal-title p-font" id="exampleModalCenterTitle"><b>Update Photo of {{$hotel->hotels_name}}</b></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form class="update-hotel-multiple-image-form">
            <div class="form-group">
                @csrf
