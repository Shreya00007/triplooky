                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                ...
                                <div class="card-body">
                                 <form class="update-place-form">
                                    @csrf
                                         <div class="form-group">
                                         <label class="p-font">Place Name</label>
                                         <input type="text" name="place-name" class="form-control shadow-none require" placeholder="Place Name" value="{{$data->place_name}}">
                                    ...
                                    <div  class="col">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control shadow-none require" name="region" id="place-region">
                                                ...
                                                <option value="{{$list->id}}" {{$data->region==$list->region? 'selected':''}}>{{$list->region}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control shadow-none place-city require" name="city">
                                                ...
                                                @if($list1->ville==$data->city)
                                                <option value="{{$list1->id}}" selected="">{{$list1->ville}}</option>
                                                @else
                                                <option value="{{$list1->id}}">{{$list1->ville}}</option>
                                                @endif
