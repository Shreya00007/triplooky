...
@section("title","Add CMS Transportation")
@section("content")
<div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="breadcrumb-content">
                            <div class="section-heading">
                                <h2 class="sec__title font-size-30 text-white p-font">CMS Transportation Setting</h2>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="breadcrumb-list text-right">
                            <ul class="list-items">
                                ...
                                <li class="p-font">CMS Transportation</li>
                        ...
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                <div class="card-header d-flex justify-content-between align-items-center py-3" style="background: #28e5f3;border-radius: 2px;">
                                    <div> <h6 class="p-font text-white"><b>Add CMS Transportation</b></h6></div>
                                   
                                </div>
                                <div class="card-body">
                                     <form action="/admin/cms/transportation/add-data"   class="city-form-insert" enctype="multipart/form-data" method="post">
                                        @csrf
                                ...
                                <div class="form-group">
                                  <button class="btn-custom p-font">Create CMS Transportation</button>
                                </div>
