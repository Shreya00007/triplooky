...
@section("title","Upadte Accomodation Photo")
@section("content")
                        ...
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                <div class="card-header d-flex justify-content-between align-items-center py-3" style="background: #28e5f3;border-radius: 2px;">
                                    <div> <h6 class="p-font text-white"><b>Update Accomodation Photo</b></h6></div>
                                   
                                   
                                </div>
                                <div class="card-body">
                                    <form method="post" action="/admin/transportation/update-more-image-transportation-data" enctype="multipart/form-data">
                                        @csrf
