...
@section("title","Transportation Edit")
@section("content")
<div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="breadcrumb-content">
                            <div class="section-heading">
                                <h2 class="sec__title font-size-30 text-white p-font">Update Transportation Setting</h2>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="breadcrumb-list text-right">
                            <ul class="list-items">
                                ...
                                <li class="p-font">Update Transportation</li>
                        ...
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                <div class="card-header d-flex justify-content-between align-items-center py-3" style="background: #28e5f3;border-radius: 2px;">
                                    <div> <h6 class="p-font text-white"><b>Update Transportation</b></h6></div>
                                   
                                </div>
                                <div class="card-body">
                                     <form action="/admin/transportation/update-transportation-data"    enctype="multipart/form-data" method="post" class="update-transportation-form">
                                        @csrf
                                         <input type="hidden" name="id" value="{{$data->id}}">
                                        <div class="form-group">
                                            <label class="p-font">Transportation</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img src="{{url('')}}/transportation-image/images/{{$data->image}}" width="100">
                                             @if($errors->has('image'))
  ...
  <input type="text" name="phone" class="form-control shadow-none " placeholder="Phone No" oninput="removeErrorshow(this)" value="{{$data->phone}}" maxlength="50" >
                                         ...
                                         <div class="form-group">
                                          ...
                                          <select class="form-control shadow-none" name="type">
                                              ...
                                              @for($i=0;$i<count($transportation_type);$i++)
                                               <option value="{{$transportation_type[$i]['name']}}" {{$transportation_type[$i]['name']==$data->type?"selected":""}}>{{$transportation_type[$i]['name']}}</option>
                                               @endfor
        ...
        <option value="{{$lang->lang_name}}" @if (old('lang_name')==$lang->lang_name) selected="selected" @endif  @if($data->driver_language==$lang->lang_name) selected="selected" @endif>{{$lang->lang_name}}</option>
                                                @endforeach
                                ...
                                <div class="form-group">
                                  <button class="btn-custom p-font">Update Transportation</button>
                                </div>
              ...
              <script type="text/javascript">
                  ...
                  $(".update-transportation-form").submit(function(){
