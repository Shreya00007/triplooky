                      ...
                      {!! session()->get("message") !!}
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                ...
                                <div class="card-body">
                                     <form  method="POST"  action="/admin/transfer/add-transfer-data">
                                        @csrf
                                        
                                        <div class="form-group">
                                            <label class="p-font">Transfer Type</label>
                                            <input type="text" name="transfer_type" class="form-control shadow-none rounded-0" placeholder="Transfer">
                                        </div>
