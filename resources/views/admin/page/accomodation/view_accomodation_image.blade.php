...
@section("title","Accomodation Photo Gallery")
@section("content")
                        ...
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                <div class="card-header d-flex justify-content-between align-items-center py-3" style="background: #28e5f3;border-radius: 2px;">
                                    <div> <h6 class="text-white p-font"><b>Accomodation Photo</b></h6></div>
                                    <div><a href="/admin/accomodation/add-more-image-accomodation/{{base64_encode($data->id)}}"><button class="btn btn-dark shadow-none d-flex justify-content-between align-items-center">
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-custom view-activity-gallery-table">
                                        ...
                                        <tr>
                                            <td>{{$key+1}}</td>
                                            <td>{{$data->name}}</td>
                                            <td><img src="{{url('')}}/accomodation-image/images/{{$list->image}}" width="100"></td>
                                            <td>
                                                @if($list->status==1)
                                                <a href="/admin/accomodation/accomodation-image-status-change/{{base64_encode($list->id)}}"><button class="btn btn-
                                                    btn-success">Active</button></a>
                                                @else
                                                 <a href="/admin/accomodation/accomodation-image-status-change/{{base64_encode($list->id)}}"><button class="btn btn-danger">Inactive</button></a>
                                                 @endif
                                            </td>
                                            <td> <a href="/admin/accomodation/accomodation-image/edit/{{base64_encode($list->id)}}"><button class="btn btn-success"><i class="la la-edit"></i></button></a>
                                             <a href="/admin/accomodation/accomodation-image/delete/{{base64_encode($list->id)}}" onclick="return confirm('Are you sure to delete')"><button class="btn btn-danger"><i class="la la-trash"></i></button></a></td>
                                        </tr>
                                        @endforeach
