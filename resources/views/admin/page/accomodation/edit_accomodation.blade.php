        ...
        <div class="dashboard-main-content mt-5">
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                ...
                                <div class="card-body">
                                     <form action="/admin/accomodation/update-accomodation-data"    enctype="multipart/form-data" method="post" class="accomodation-update-form">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                          ...
                                          <select class="form-control shadow-none" name="type">
                                             ...
                                             <option value="{{$accomodation_list->name}}" {{$data->type==$accomodation_list->name?"selected":""}}>{{$accomodation_list->name}}</option>
                                             @endforeach
              ...
              <script type="text/javascript">
                  ...
                  $(".accomodation-update-form").submit(function(){
