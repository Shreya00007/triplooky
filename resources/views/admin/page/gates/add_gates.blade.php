                        ...
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                <div class="card-header d-flex justify-content-between align-items-center py-3" style="background: #28e5f3;border-radius: 2px;">
                                    <div> <h5 class="text-white p-font"><b>Add New Gates</b></h5></div>
                                    <div><span></span></div>
                                </div>
                                <div class="card-body">
                                     <form  class="gate-form">
                                        ...
                                        <div class="row">
                                           ...
                                           <div class="col">
                                            ...
                                            <input type="text" name="type" class="form-control shadow-none rounded-0 require" placeholder="Type">
                                        </div>
                                           </div>
                                           <div class="col">
                                               <div class="form-group">
                                            <label class="p-font">Room Type</label>
                                            <input type="text" name="room_type" class="form-control shadow-none rounded-0 require" placeholder="Room Type">
                                        </div>
                                           </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="number" name="budget" class="form-control shadow-none rounded-0 require" placeholder="Budget">
                                        </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group">
                                           ...
                                           <select class="form-control shadow-none require" name="status">
                                            ...
                                            <input type="number" name="rating" class="form-control shadow-none rounded-0 require" placeholder="Rating">
                                        </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="text" name="location" class="form-control shadow-none rounded-0 require" placeholder="Location">
                                        </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <div class="editor desc" data="Facility"></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-0 d-flex justify-content-between align-items-center">
                                            <button class="btn-custom p-font">Create Gates</button>
