                    ...
                    <div class="col-lg-6">
                        <div class="breadcrumb-content">
                            <div class="section-heading">
                                <h2 class="sec__title font-size-30 text-white p-font">Sub Category Setting</h2>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="breadcrumb-list text-right">
                            <ul class="list-items">
                                ...
                                <li class="p-font"> Sub Category</li>
                        ...
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                <div class="card-header d-flex justify-content-between align-items-center py-3" style="background: deeppink;border-radius: 2px;">
                                    <div> <h5 class="p-font text-white"><b> Sub Category List</b></h5></div>
                                     ...
                                     <table class="table table-custom">
                                         ...
                                         <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($list->status==1)
                                                    <a href="/admin-sub-category-status-change/{{base64_encode($list->sub_category_name)}}"><button class="btn btn-success shadow-none sub-category-status-btn" data="{{$list->id}}" status="1">Active</button></a>
                                                    @else
                                                    <a href="/admin-sub-category-status-change/{{base64_encode($list->sub_category_name)}}"> <button class="btn btn-danger shadow-none " data="{{$list->id}}" status="0">inactive</button></a>
                                                    @endif
                                                </td>
                                                <td>
                                                    <div class="d-flex justify-content-center align-items-center">
                                                        <a href="/admin/edit-sub-category/{{base64_encode($list->id)}}"><button class="edit-city-btn icon-btn bg-success text-white mr-2" data=""><i class="la la-edit"></i>
                                                        </button></a>
                                                        <a href="/admin/delete-sub-category/{{base64_encode($list->id)}}"><button class="icon-btn  btn-danger text-white shadow-none" data="{{$list->id}}"><i class="la la-trash"></i></button></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            @endforeach
