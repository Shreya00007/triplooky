                        ...
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                <div class="card-header d-flex justify-content-between align-items-center py-3" style="background: #28e5f3;border-radius: 2px;">
                                    <div> <h5 class="text-white p-font"><b>Add New Sub Category</b></h5></div>
                                    <div><span></span></div>
                                </div>
                                <div class="card-body">
                                     <form  method="POST"  action="/admin/add-sub-categeory-data">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sub_category_name" class="form-control shadow-none rounded-0" placeholder="Sub Category Name">
                                        </div>
                                        ...
                                        <div class="form-group mb-0 d-flex justify-content-between align-items-center">
                                            <button class="btn-custom p-font">Create Sub Category</button>
