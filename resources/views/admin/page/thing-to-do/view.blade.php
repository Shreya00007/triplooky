...
@section("title","View Thing to do")
@section("content")
                                     ...
                                     <table class="table text-center table-custom">
                                        ...
                                        <tr>
                                         ...
                                         <td>{{$list->heading}}</td>
                                           ...
                                           <td><img src="{{url('')}}/thing-to-do/{{$list->image}}" width="100"></td>

                                           <td>

                                               @if($list->status==0)

                                              <a href="/admin/thing-to-do/status/{{base64_encode($list->id)}}"> <button class="btn btn-danger shadow-none" data="{{$list->id}}">inactive</button>

                                              </a>

                                               @else

                                               <a href="/admin/thing-to-do/status/{{base64_encode($list->id)}}"> <button class="btn btn-success shadow-none" data="{{$list->id}}">active</button></a>
