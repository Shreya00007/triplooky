...
@section("title","Edit Thing to do Gallery")
@section("content")
                    ...
                    <div class="col-lg-12">
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                ...
                                <div class="card-body">
                                     <form class="update-activity-gallery-form">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control shadow-none" name="activity_name" disabled>
                                               ...
                                               @if($data->activity_id==$list->id)
                                               <option value="{{$list->id}}" selected="">{{$list->activity_name}}</option>
                                               @else
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="activity_image" class="form-control shadow-none" >
                                            <img src="{{url('')}}/Activity Gallery/{{$activity_name->activity_name}}/{{$data->image}}" width="100">
                                        </div>
