        ...
        <div class="dashboard-main-content mt-5">
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                ...
                                <div class="card-body">
                                     <form action="/admin/food-and-drink/add-food-and-drink-data"    enctype="multipart/form-data" method="post" class="add-food-and-drink-form">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="input-group">
                                              ...
                                              <input type="text" name="phone" class="form-control shadow-none" placeholder="Phone No"  value="{{old('phone')}}" maxlength="50" oninput="removeErrorshow(this)">
                                            </div> 
                                             @if($errors->has('phone'))
                                         ...
                                         <div class="form-group">
                                          ...
                                          <select class="form-control shadow-none" name="type">
                                              ...
                                              <option value="{{$fooddrink[$i]['name']}}">{{$fooddrink[$i]['name']}}</option>
                                              @endfor
              ...
              <script type="text/javascript">
                  ...
                  $(".add-food-and-drink-form").submit(function(){
