...
@section("title","Add Food And Drink  Photo")
@section("content")
                        ...
                        <div class="form-box">
                            <div class="card" style="border:none;box-shadow: 0px 0px 5px black;border-radius: 2px;">
                                <div class="card-header d-flex justify-content-between align-items-center py-3" style="background: #28e5f3;border-radius: 2px;">
                                    <div> <h6 class="p-font text-white"><b>Add Food And Drink Photo</b></h6></div>
                                    <div><a href="/admin/food-and-drink/view-more-image/{{base64_encode($data->id)}}"><button class="btn btn-dark"><i class="la la-arrow-right"></i></button></a></div>
                                   
                                </div>
                                <div class="card-body">
                                    <form method="post" action="/admin/food-and-drink/add-more-image-food-and-drink-data" enctype="multipart/form-data">
                                        @csrf
