   ...
   <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        @for($i=0 ;$i<count($imagedata);$i++)
         <div class="carousel-item {{$i==0?"active":""}}" style="background-image: url({{url('')}}/Must-do-and-see/images/{{$imagedata[$i]['image']}})"></div>
        @endfor
...
<main id="main" class="padtb40">
  <div class="container-fluid bodyPad">
    ...
    <br><br>
    <center><h4>Related Must Do And See</h4></center>
    <br><br>
     <div class="row">
     @for($i=0;$i<count($related_data);$i++)
      ...
      <div class="col-md-3 form-group">
        <div class="ntSection">
          <a href="/nature/{{$data['city_name']}}/{{$related_data[$i]['name']}}">
            <img src="{{url('')}}/Must-do-and-see/images/{{$related_data[$i]['image']}}" alt="n">
