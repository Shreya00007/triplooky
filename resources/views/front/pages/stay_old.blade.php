               ...
               <a data-toggle="modal" href="#myModal">
                  <div class="card service-card card-inverse hotel">
                     <div class="card-block">
                        <img src="{{url('')}}/front-assets/assets/img/hotel_icon.png">
                     </div>
                  </div>
            ...
            <div class="col-md-3">
               <a data-toggle="modal" href="#myModal">
                  <div class="card service-card card-inverse apt">
                     <div class="card-block">
                        <img src="{{url('')}}/front-assets/assets/img/Apartment_ic.png">
                     </div>
                  </div>
                  <div class="text-center">
            ...
            <div class="col-md-3">
               <a data-toggle="modal" href="#myModal">
                  <div class="card service-card card-inverse ride">
                     <div class="card-block">
                        <img src="{{url('')}}/front-assets/assets/img/Ride_ic.png">
            ...
            <div class="col-md-3">
               <a data-toggle="modal" href="#myModal">
                  <div class="card service-card card-inverse guide">
                     <div class="card-block">
                        <img src="{{url('')}}/front-assets//assets/img/Guide_map_ic.png">
                     </div>
                  </div>
                  <div class="text-center">
                     ...
                     <div class="row">
                        <div class="col-md-5">
                           <div class="containerr">
                              <img src="{{url('')}}/hotels_image/images/thumb_image/{{$list->thumb_image}}">
                              <div class="contentt">
                                 <p>Deal 38% cheaper</p>
                              </div>
                           </div>
                        ...
                        <div class="col-md-7">
                           <div class="maptextt">
                              ...
                              <div class="textboxww">
                                 ...
                                 <a href="{{$list->hotel_link}}"><p class="alignright bbvb">₹{{$list->price}}/Night</p></a>
                              </div>
                           </div>
                        </div>
                     </div>
