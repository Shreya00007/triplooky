...
<html>
<head>
  <title>Triplooky | Forgot Password</title>
  <meta charset="utf-8">
...
<div class="wrapper">
  <div class="container">
    ...
    <img src="{{url('')}}/front-assets/assets/img/logo.png">	
    <h6 class="name">Welcome to Triplooky</h6>
    <p class="text-center mt-5 mb-5">Please enter your username or email address. You will receive a link to create a new password via email.</p>
    <form class="form text-left">
    	<div class="form-group">	    	
	      	<input type="email" id="user" class="form-control" placeholder="Username or E-mail:">
	  	</div> 			
      <button type="submit" id="login-button">Get New Password</button>
    </form>
