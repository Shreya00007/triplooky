...
<section id="hero">
   <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="homeSliderText">
         <div class="container">
            <!--  id="planT" -->
            <h2 class="text-center f24">{{ucwords( str_replace("and","&",str_replace('_', ' ', $data[0]['type'])))}} in {{$city_name}}</h2>
         </div>
      </div>
   </div>
</section>
...
<main id="main" class="padtb40">
  <div class="container-fluid bodyPad">
    <div class="brdCrum text-center">
      ...
      <a href="/{{ucwords( str_replace("and","&",str_replace('_', ' ', $data[0]['type'])))}}" class="brd_link">{{ucwords( str_replace("and","&",str_replace('_', ' ', $data[0]['type'])))}}</a>
