        ...
        <div class="col-md-9 tour-box">
            ...
            <div class="card tour-card-box" style="box-shadow: 0px 0px 5px rgba(0, 0, 0, 0.4);border-radius: 2px;height: fit-content;border-radius: 2px;">
                <div class="card-body py-2 px-2">
                    <div class="row">
                <div class="col-sm-3">
                    <img src="{{url('')}}/admin-asstes/images/activity_image/{{$list->activity_image}}" width="100%" class="shadow-sm">
                </div>
                <div class="col-sm-7">
                    <h6>
{{$list->activity_name}}</h6>
<i class="fa fa-star" style="color:orange;font-size: 15px;"></i><i class="fa fa-star" style="color:orange;font-size: 15px;"></i>
            ...
            <div>{!! Str::limit($list->overview, 290, ' ...') !!}</div>
                ...
                <div class="col-sm-2">
                    ...
                    <h5>USD {{$list->price}}</h5>
                    <a href="/search/tour/activity/{{$list->city_name}}/{{$list->activity_name}}"><button class="btn btn-info shadow-none p-font px-4 text-white">Details</button></a>
                </div>
            </div>
                </div>
            </div>
