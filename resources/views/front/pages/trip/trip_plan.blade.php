						...
						<form>
							...
							<!--- <div class="form-middle mt-5 mb-5">
								<div style="position: relative;">
									<input role="combobox" id="" type="text" class="search biginput form-control" autocomplete="off" aria-owns="res" aria-autocomplete="both" placeholder="Enter Destination " name="destination[]">
								</div>
								<div class="apF">
									
								</div>
								<div class="autocomplete-suggestions" id="search-autocomplete"></div>
								<a href="javascript:void(0);" class="addDestinationbtn text-white">+ Add destination</a>
							</div> 
						-->
							...
							<div class="d-flex mt-5">
								<div id="reportrange" class="pull-left posRe">
			                          ...
			                          <input type="text" class="form-control abs g travel-date" placeholder="Arrival Date 🠒 Departure Date" id="reportrange" name="trip_date">
								...
								<div class="travL mt-3">
									...
									<div class="travlNo travel-box">
											<div>
												<span class="tb">Adult</span>
												<span class="bt">
													<div class="value-button" id="decrease" onclick="decreaseValue()" value="Decrease Value">-</div>
													  <input type="number" id="number" value="0"/ class="adult">
											...
											<div>
												...
												<span class="bt">
													<div class="value-button" id="decrease1" onclick="decreaseValue1()" value="Decrease Value">-</div>
													  <input type="number" id="number1" value="0" / class="teen">
											...
											<div>
												...
												<span class="bt">
													<div class="value-button" id="decrease2" onclick="decreaseValue2()" value="Decrease Value">-</div>
													  <input type="number" id="number2" value="0" / class="kid">
							...
							<a href="javascript:void(0)" class="btn btn-success next-trip-btn" id="saveTrip">Next</a>
						</form>
					</div>
				</div>
			</div>
...
<script>
	$('.addDestinationbtn').click(function() {
		$(".apF").append('<div style="position: relative;">	<input role="combobox" id="" type="text" class="biginput search form-control" autocomplete="off" aria-owns="res" aria-autocomplete="both" placeholder="Enter Destination " name="destination[]"><i class="fas fa-times-circle" id="help"></i></div>');
	})
