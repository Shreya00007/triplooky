                     ...
                     <div class="row">
                        <div class="col-md-5">
                           <div class="containerr">
                              <img src="{{url('')}}/tour/images/{{$tour[$i][$j]['image']}}">
                              <div class="contentt">
                                 <p>Deal 38% cheaper</p>
                              </div>
                           </div>
                        ...
                        <div class="col-md-7">
                           <div class="maptextt">
                              <div class="textboxww">
                                 <p class="alignleft">{{$tour[$i][$j]['heading']}}</p>
                                 <p class="alignright"><span id = "heart" href="javascript:void(0)"><i class="far fa-heart" aria-hidden="true" ></i> </span></p>
                              </div>
                              <div class="rp1">
                                 <p>{{$tour[$i][$j]['heading']}}</p>
                              </div>
                              <div class="ratingg d-flex">
                                 <p class="box9">9.1</p>
                                 <p class="box8">Guest rating (129 rewies)</p>
                              </div>
                              <p class="box7">Overview: {!! $tour[$i][$j]['overview'] !!}</p>
                              <div class="textboxww">
                                 <p class="alignleft text-danger">Only 1 room left</p>
                                 
                              </div>
                              <div class="textboxww d-flex justify-content-between align-items-center">
                                 <p class="alignleft">proximity 9.8</p>
                                  <div class="mb-3"> <button class="btn btn-primary shadow-none" style="border-radius: 3rem;color: white"> <a href="/tour/booking/{{$tour[$i][$j]['heading']}}" class="text-white">Booking{{$tour[$i][$j]['price']}}/Night</a></button></div>
