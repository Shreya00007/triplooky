...
@section("title","Tour About Details")
@section("content")
<div class="container-fluid bodyPad mb-5 mt-4">
   <div class="mb-3 d-flex justify-content-between align-items-center">
      <div class="d-flex" style="font-size:12px;"><a href="/">Home</a>><a href="">Tour</a>><a href="">{{$data->category_name}}</a><span>></span><a href="">{{$data->city_name}}</a><span>></span><a href="">{{$data->heading}}</a></div>
      <div style="font-size:10px;"><p class="p-font p-0 m-0">{{$data->heading}}-with Reviews & Ratings</p></div>
   </div>
